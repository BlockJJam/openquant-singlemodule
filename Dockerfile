...
RUN echo ${DATABASE_DEPOLY_URL} $DATABASE_DEPOLY_URL "$DATABASE_DEPOLY_URL"
RUN echo ${DATABASE_DEPOLY_ID} $DATABASE_DEPOLY_ID "$DATABASE_DEPOLY_ID"
RUN echo ${DATABASE_DEPOLY_PWD} $DATABASE_DEPOLY_PWD "$DATABASE_DEPOLY_PWD"
