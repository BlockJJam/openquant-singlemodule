...
WORKDIR /home/quant
ENTRYPOINT ["java", "-jar","SpringApp.jar","--spring.profiles.active=${APPLICATION_YAML_PATH}","--spring.datasource.url=${DATABASE_DEPLOY_URL} --spring.datasource.username=${DATABASE_DEPLOY_ID} --spring.datasource.password=${DATABASE_DEPLOY_PWD}"]
